          ...
          <div className="relative flex flex-col w-64 bg-white shadow-xl">
            ...
            <nav className="flex-1 p-4 space-y-2">
              ...
              {(user.role === 'admin' || user.isAdmin) && (
                <Link href="/admin" className="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-slate-100 text-slate-700 transition-colors">
      ...
      <div className="flex">
        ...
        <div className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-white border-r border-slate-200">
          ...
          <nav className="flex-1 p-4 space-y-2">
            ...
            {(user.role === 'admin' || user.isAdmin) && (
              <Link href="/admin" className="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-slate-100 text-slate-700 transition-colors">
                <Settings className="w-4 h-4" />
